...
const uint16_t  THUMB_LDRB_STRB_imm_1_masks[] = {0b0000000000000111, 0b00000000000111000, 0b0000011111000000};
const int       THUMB_LDRB_STRB_imm_1_shifts[]= {                 0,                3   ,            6      };
const THUMB16_t THUMB_LDRB_imm_1              = {0b0111100000000000, 3, THUMB_LDRB_STRB_imm_1_masks, THUMB_LDRB_STRB_imm_1_shifts};
const THUMB16_t THUMB_STRB_imm_1              = {0b0111000000000000, 3, THUMB_LDRB_STRB_imm_1_masks, THUMB_LDRB_STRB_imm_1_shifts};
...
const uint16_t  THUMB_MOV_2_masks[]  = {0b0000000000000111, 0b0000000000111000};
const int       THUMB_MOV_2_shifts[] = {                 0,               3   };
const THUMB16_t THUMB_MOV_2          = {0b0000000000000000, 2, THUMB_MOV_2_masks, THUMB_MOV_2_shifts};
...
const uint16_t  THUMB_MUL_1_masks[] = {0b0000000000000111, 0b00000000000111000};
const int       THUMB_MUL_1_shifts[]= {                 0,                3   };
const THUMB16_t THUMB_MUL_1         = {0b0100001101000000, 2, THUMB_MUL_1_masks, THUMB_MUL_1_shifts};

const uint16_t  THUMB_SXTB_1_masks[] = {0b0000000000000111, 0b00000000000111000};
